...
class IdeationLogTests(unittest.TestCase):
    ...
    def test_ignores_non_record_footer(self) -> None:
        summary = ideation_log.parse_and_validate(
            log(
                "## Wednesday, August 19, 2026", "", "### Motion", "", entry("20260819-000001", "Idea: Preserved"), "", "---", "",
                "Rights And Reuse", "", "Notice.",
            )
        )
        self.assertEqual(summary.records[0]["title"], "Preserved")
